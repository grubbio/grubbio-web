...
USERS = [	{user_email: "consumer@grubb.io", password: "password", location: "Denver, CO", registration_roles: ["consumer"]},
					...
					{user_email: "market@grubb.io", password: "password", location: "Denver, CO", registration_roles: ["market_manager"]},
					{user_email: "admin@grubb.io", password: "password", location: "denver, CO", registration_roles: ["admin"]}
				]
